...
<li>how to do large scale collaborations?</li>
</ul>
...
* It reveals its power (and actually is created) via pilot projects, e.g.:
    ...
    * Metamaps.cc [http://metamaps.cc/](http://metamaps.cc/)
    * ...?
* There is no ready-made solution, but many tools, approaches and guidelines which should be adapted to specific circumstances;
...
GBI-OVN is a value (scientific, monetary, otherwise) creation, sharing and distribution network based on the synergy of internal and external resources and people towards developing The Global Brain theory and technologies. 

The network guides the self-organization of diverse expertise, knowledge, resources and financial sources (EU funds, commercial projects and philantropy), people and ideas sharing the same broad vision.
</div>